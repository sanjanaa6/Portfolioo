      ...
      <div className="section-shell relative z-10">
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left z-10">
            ...
            <p className="mx-auto max-w-xl text-sm sm:text-base leading-7 text-stone-400 lg:mx-0">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-3 pt-8 border-t border-white/5">
